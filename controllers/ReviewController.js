...
const storeReview = (req,res)=>{
    ...
    const query = `
        ...
        VALUES (?,?,?,?)
    `;
    const params = [bookId,name,rating,review];
...
const updateReview = (req,res)=>{
    ...
    connection.query(query,params,(err,result)=>{
        ...
        return res.status(200).json({message: `Book id ${reviewId} reviews updated successfully`});
    });
};
